...
$sql = "SELECT products.id, products.name, products.quantity, products.status, products.last_updated, products.expiredate,
...
if (!empty($filter_status)) $sql .= " AND products.status = '" . mysqli_real_escape_string($conn, $filter_status) . "'";
$sql .= " ORDER BY products.expiredate $sort_order";

$result = mysqli_query($conn, $sql);

inv_layout_start('Stock', 'store', 'sales', 'bi-boxes');
?>
...
<form method="GET" class="filter-bar mb-3">
    <div class="row g-3 align-items-end">
        ...
        <div class="col-md-3">
            <button type="submit" class="btn btn-inv w-100"><i class="bi bi-funnel me-1"></i> Apply Filter</button>
        </div>
    </div>
</form>
        ...
        <table class="table inv-table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../actions/stock-update.php?supdateid=<?= $row['id'] ?>" class="btn btn-sm btn-inv"><i class="bi bi-box-arrow-right me-1"></i>Take-Out</a>
                    </td>
                </tr>
                <?php endwhile;
                else: ?>
