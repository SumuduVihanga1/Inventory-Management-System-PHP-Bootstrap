...
$stats['total_instock'] = ($inStockResult && $row = $inStockResult->fetch_assoc()) ? $row['v'] : 0;
...
inv_layout_start('Dashboard', 'admin', 'dashboard', 'bi-speedometer2', $loggedInUsername, 'Welcome admin');
?>
